...
ms2Gallery.window.Uploader = function(config) {
	config = config || {};

	Ext.applyIf(config, {
		title: _('ms2gallery_uploader'),
		cls: 'ms2gallery ' + (MODx.modx23 ? 'modx23' : 'modx22'),
		width: 700,
		autoHeight: true,
		resizable: false,
	...
	ms2Gallery.window.Uploader.superclass.constructor.call(this, config);
...
Ext.extend(ms2Gallery.window.Uploader, MODx.Window);
Ext.reg('ms2gallery-uploader-window', ms2Gallery.window.Uploader);